package pl.mbassara.jnapi.gui.mediainfo;
...
interface MediaInfoLibrary extends Library {
    ...
    MediaInfoLibrary INSTANCE = (MediaInfoLibrary) Native.loadLibrary(
            "mediainfo", MediaInfoLibrary.class,
     ...
     * is a problem
     */
    WString Get(Pointer handle, int streamKind, int streamNumber,
                WString parameter, int infoKind, int searchKind);
     ...
     * is a problem
     */
    WString GetI(Pointer handle, int streamKind, int streamNumber,
                 int parameterIndex, int infoKind);
